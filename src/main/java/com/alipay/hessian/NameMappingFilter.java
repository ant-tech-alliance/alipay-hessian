...
/**
 * 某些情况下，需要将OldClass序列化的类，用NewClass去解析
 * <p>
...
public class NameMappingFilter implements ClassNameFilter {
     ...
     * 保留映射关系 旧类-->新类
     */
    private static final ConcurrentLinkedHashMap<String, String> objectMap
     ...
     */
    public static void registerMapping(String oldClass, String newClass) {
     ...
     * @param oldClass the old class
     */
    public static void unregisterMapping(String oldClass) {
